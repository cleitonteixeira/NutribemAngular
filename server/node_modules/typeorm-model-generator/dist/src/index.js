...
function checkYargsParameters(options) {
    ...
    options.generationOptions.convertCaseEntity = argv.ce;
    options.generationOptions.convertCaseFile = argv.cf;
    options.generationOptions.convertCaseProperty = argv.cp;
    options.generationOptions.convertEol = argv.eol;
    ...
    options.generationOptions.propertyVisibility = argv.pv;
    ...
    options.generationOptions.strictMode = argv.strictMode;
...
async function useInquirer(options) {
    ...
    if (customizeGeneration) {
        ...
        options.generationOptions.noConfigs = !customizations.includes("config");
        options.generationOptions.pluralizeNames = customizations.includes("pluralize");
        options.generationOptions.lazy = customizations.includes("lazy");
        options.generationOptions.activeRecord = customizations.includes("activeRecord");
        options.generationOptions.relationIds = customizations.includes("relationId");
        options.generationOptions.skipSchema = customizations.includes("skipSchema");
        options.generationOptions.generateConstructor = customizations.includes("constructor");
